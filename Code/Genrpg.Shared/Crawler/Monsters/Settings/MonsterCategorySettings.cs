...
{
    [MessagePackObject]
    public class MonsterCategory : ChildSettings, IIndexedGameItem, IMonsterInfo
    {
    ...
    [MessagePackObject]
    public class MonsterCategorySettings : ParentSettings<MonsterCategory>
    {
        [Key(0)] public override string Id { get; set; }
    ...
    [MessagePackObject]
    public class MonsterCategorySettingsApi : ParentSettingsApi<MonsterCategorySettings, MonsterCategory> { }
    [MessagePackObject]
    public class MonsterCategorySettingsLoader : ParentSettingsLoader<MonsterCategorySettings, MonsterCategory, MonsterCategorySettingsApi> { }
