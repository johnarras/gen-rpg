...
namespace Genrpg.Shared.Crawler.States.StateHelpers.Tavern
{
    public class TavernMainHelper : BaseStateHelper
    {
        ...
        public override async Task<CrawlerStateData> Init(CrawlerStateData currentState, CrawlerStateAction action, CancellationToken token)
        {
            ...
            stateData.Actions.Add(new CrawlerStateAction("New Game", 'N', ECrawlerStates.TavernMain, null, "GenerateWorld"));
