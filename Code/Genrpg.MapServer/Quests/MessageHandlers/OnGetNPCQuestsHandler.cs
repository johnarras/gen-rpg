...
{
    public class OnGetNPCQuestsHandler : BaseServerMapMessageHandler<OnGetNPCQuests>
    {
        protected override void InnerProcess(GameState gs, MapMessagePackage pack, MapObject obj, OnGetNPCQuests message)
        {
