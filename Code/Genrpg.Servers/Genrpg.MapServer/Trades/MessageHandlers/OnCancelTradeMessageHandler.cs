...
{
    public class OnCancelTradeHandler : BaseServerMapMessageHandler<OnCancelTrade>
    {
        private ITradeService _tradeService;
        protected override void InnerProcess(GameState gs, MapMessagePackage pack, MapObject obj, OnCancelTrade message)
        {
