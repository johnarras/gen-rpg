...
{
    public class UpdateTradeHandler : BaseServerMapMessageHandler<UpdateTrade>
    {
        private ITradeService _tradeService;
        protected override void InnerProcess(GameState gs, MapMessagePackage pack, MapObject obj, UpdateTrade message)
        {
