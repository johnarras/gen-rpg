...
{
    public class OnAcceptTradeHandler : BaseServerMapMessageHandler<OnAcceptTrade>
    {
        private ITradeService _tradeService;
        protected override void InnerProcess(GameState gs, MapMessagePackage pack, MapObject obj, OnAcceptTrade message)
        {
