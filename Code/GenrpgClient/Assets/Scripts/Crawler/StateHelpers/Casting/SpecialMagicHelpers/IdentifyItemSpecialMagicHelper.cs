...
namespace Assets.Scripts.Crawler.StateHelpers.Casting.SpecialMagicHelpers
{
    ...
    {
        public override long GetKey() { return SpecialMagics.IdentifyItem; }

        public override async Awaitable<CrawlerStateData> HandleEffect(CrawlerStateData stateData, SelectSpellAction action, 
