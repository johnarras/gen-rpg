...
namespace Services.ProcGen
{
    ...
    public class MapGenService : IMapGenService
    {
        ...
        protected virtual long GetZoneTypeId(UnityGameState gs, Map map, MyRandom rand)
        {
            ...
            List<ZoneType> zoneTypes = gs.data.GetGameData<ProcGenSettings>().ZoneTypes;
            if (zoneTypes == null)
            {
                return 0;
            }
        ...
        public void CreateZones(UnityGameState gs)
        {
            ...
            ZoneType waterZoneType = gs.data.GetGameData<ProcGenSettings>().ZoneTypes.FirstOrDefault(X => X.Name == "Water");
            ...
            if (gs.data.GetGameData<ProcGenSettings>().ZoneTypes == null)
            {
                return;
            }

            foreach (ZoneType zt in gs.data.GetGameData<ProcGenSettings>().ZoneTypes)
            {
